            ...
            :
              ...
              >
                    <div className="sysMsg">
                      ...
                      <div className="text-center text-[#7A8E8B] font-bold">可能是因為</div>
                      <div className="mt-4 px-4">
                        <li className="text-[#7A8E8B] text-xs">未進行 - 數位分身掃描</li>
                        <div className="text-[#62A9A5] text-xs pl-4 my-2">前往數位分身掃瞄區，完成掃描吧！</div>
                        <li className="text-[#7A8E8B] text-xs mt-4">已進行 - 數位分身掃描</li>
                        <div className="text-[#62A9A5] text-xs pl-4 my-2">數位分身正在建立中，請等候完成！</div>
